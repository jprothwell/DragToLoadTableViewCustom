...
- (void)viewDidLoad {
	...
	[dataArray addObjectsFromArray:[NSArray arrayWithObjects:nil]];
...
-(void)startLoadTop {
	[self performSelector:@selector(finishedLoadingTop) withObject:nil afterDelay:2];
}

-(void)startLoadButtom {
	[self performSelector:@selector(finishedLoadingBottom) withObject:nil afterDelay:2];
}
